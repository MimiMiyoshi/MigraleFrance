...
const culturalNotifications = [
  {
    title: "フランス文化のヒント",
    message: "フランスでの挨拶は「Bonjour」（ボンジュール）とともに軽いキスを頬に2回（地方によっては3〜4回）交わすのが一般的です。",
    culturalTheme: "💡 フランスでの社交マナー",
  },
  {
    title: "フランス語のフレーズ",
    message: "「S'il vous plaît」（シルヴプレ）は「お願いします」という意味です。お店やレストランで使うと印象が良くなります。",
    culturalTheme: "🗣️ 日常会話で使えるフランス語",
  },
  {
    title: "フランスの生活習慣",
    message: "フランスでは昼食に2時間かけることも珍しくありません。食事はただの栄養摂取ではなく、重要な社交の時間と考えられています。",
    culturalTheme: "🍷 フランスの食文化",
  },
  {
    title: "公共交通機関のエチケット",
    message: "パリのメトロ（地下鉄）では、乗車時に「Navigo」カードか切符を持っていることが必要です。検札が頻繁にあります。",
    culturalTheme: "🚇 パリでの移動手段",
  },
  {
    title: "フランスの祝日",
    message: "5月は祝日が多いフランス。5/1（労働の日）、5/8（戦勝記念日）に加え、キリスト教に関連する祝日も多いです。",
    culturalTheme: "📅 フランスの年中行事",
  },
  {
    title: "ビジネスマナー",
    message: "フランスのビジネスシーンでは、初対面でも「tu」ではなく「vous」（丁寧な「あなた」）を使うのがマナーです。",
    culturalTheme: "👔 フランスのビジネス文化",
  },
  {
    title: "フランスの住宅事情",
    message: "アパート契約時は「Dossier」と呼ばれる書類セット（収入証明、保証人情報など）の提出が求められます。事前に用意しておくとスムーズです。",
    culturalTheme: "🏠 フランスでの住居探し",
  },
  {
    title: "医療システム",
    message: "フランスの医療システム「Sécu」（社会保障）は世界でも評価が高く、適切な手続きを行えば医療費の大部分が払い戻されます。",
    culturalTheme: "🏥 フランスの医療制度",
  },
  {
    title: "フランスのカフェ文化",
    message: "「Un café, s'il vous plaît」（アン・カフェ・シルヴプレ）でエスプレッソが注文できます。アメリカンコーヒーは「café allongé」と言います。",
    culturalTheme: "☕ カフェでの注文方法",
  },
  {
    title: "市場でのお買い物",
    message: "フランスの多くの町では週に1〜2回「marché」（市場）が開かれます。新鮮な食材を買うだけでなく、地元の文化に触れる良い機会です。",
    culturalTheme: "🥖 地元の市場文化",
  }
];

// ランダムな文化的通知を生成する関数
const getRandomCulturalNotification = (): Omit<NotificationType, "id" | "createdAt" | "read"> => {
