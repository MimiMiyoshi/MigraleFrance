...
const recommendedTasks: Record<string, Task[]> = {
  短期滞在シェンゲンビザ: [
    {
      title: "有効なパスポートの準備",
      description:
        "フランスからの出国予定日から少なくとも3ヶ月間有効なパスポートを確保してください",
    },
    {
      title: "ビザ申請書の記入",
      description: "シェンゲンビザ申請書に記入してください",
    },
    {
      title: "旅行保険の加入",
      description: "最低30,000ユーロの補償範囲を持つ旅行保険に加入してください",
    },
    {
      title: "証明書類の収集",
      description: "旅程表、宿泊予約、および資金証明を準備してください",
    },
  ],
  長期学生ビザ: [
    {
      title: "入学許可書の取得",
      description: "フランスの教育機関からの入学許可書を取得してください",
    },
    {
      title: "資金証明の準備",
      description:
        "滞在に十分な資金があることを示す書類を集めてください（月約615ユーロ）",
    },
    {
      title: "Campus Franceへの登録",
      description:
        "あなたの国に適用される場合、予備登録プロセスを完了してください",
    },
    {
      title: "宿泊証明の準備",
      description: "フランスでの宿泊証明を取得してください",
    },
  ],
  "長期学生ビザ（滞在許可証付き）": [
    {
  ...
  長期就労ビザ: [
    {
      title: "労働契約書の取得",
      description: "フランスの雇用主から署名入りの労働契約書を取得してください",
    },
    {
      title: "就労許可の申請",
      description:
        "雇用主はフランスの労働当局から就労許可を申請する必要があります",
    },
    {
      title: "職業資格の準備",
      description: "あなたの職業資格と経験の証明書を集めてください",
    },
    {
      title: "財務書類の準備",
      description: "財政的安定性を示す銀行明細書を準備してください",
    },
  ],
  家族呼び寄せビザ: [
    {
      title: "家族関係書類の収集",
      description:
        "結婚証明書、出生証明書、およびその他の家族関係書類を収集してください",
    },
    {
      title: "スポンサーの書類の準備",
      description:
        "フランス居住者の滞在許可証、宿泊証明、および資金証明を集めてください",
    },
    {
      title: "公式書類の翻訳",
      description:
        "すべての書類を認定翻訳者によってフランス語に翻訳してもらってください",
    },
    {
      title: "健康診断の予約",
      description: "必要に応じて健康診断を予約してください",
    },
  ],
  高度人材パスポートまたは投資家ビザ: [
    {
      title: "ビジネスプランの準備",
      description:
        "フランスでの投資やプロジェクトのための詳細なビジネスプランを作成してください",
    },
    {
      title: "財務証明の収集",
      description:
        "投資する財政的能力を示す書類を編集してください（一部のカテゴリでは最低30,000ユーロ）",
    },
    {
      title: "専門的な推薦状の取得",
      description: "推薦状や専門的な参考資料を集めてください",
    },
    {
      title: "関連する学位/証明書の準備",
      description: "あなたの教育や専門的な証明書を準備してください",
    },
  ],
  "長期滞在ビザ（詳細な相談を推奨）": [
    {
      title: "相談の予約",
      description:
        "個別のガイダンスを受けるためにフランス領事館との面会を予約してください",
    },
    {
      title: "基本的な書類の準備",
      description: "パスポート、写真、および基本的な身分証明書を集めてください",
    },
    {
      title: "ビザカテゴリの調査",
      description:
        "あなたの状況に適用される可能性のある様々なビザカテゴリを調査してください",
    },
    {
      title: "財政的要件の確認",
      description: "異なるビザタイプの財政的要件を理解してください",
    },
  ],
  "EU市民 - ビザ不要": [
    {
      title: "有効なIDカードまたはパスポートの準備",
      description:
        "有効な国民IDカードまたはパスポートを持っていることを確認してください",
    },
    {
      title: "地方自治体への登録",
      description:
        "3ヶ月以上の滞在の場合、地方自治体に登録する必要があるかもしれません",
    },
    {
      title: "欧州健康保険カードの取得",
      description:
        "一時的な滞在にはEHICを申請するか、長期滞在の場合はフランスの医療制度に登録してください",
    },
    {
      title: "居住要件の調査",
      description:
        "EU市民としてフランスでの居住を確立するための要件を理解してください",
    },
  ],
};
...
const VisaResultPage = () => {
  ...
  useEffect(() => {
    if (response && response.result && recommendedTasks[response.result]) {
      setSelectedTasks(
        new Array(recommendedTasks[response.result].length).fill(false)
      );
    }
  }, [response]);
        ...
        <main className="flex-grow py-12 bg-gray-50">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <Card className="shadow-lg bg-red-50">
              ...
              <CardContent>
                <p>
                  ビザ推奨情報を読み込めませんでした。もう一度お試しいただくか、アンケートに戻ってください。
                </p>
              </CardContent>
              <CardFooter>
  ...
  const tasksForVisaType = response.result
    ? recommendedTasks[response.result] || []
    : [];
          ...
          <Card className="shadow-lg mb-8">
            ...
            <CardFooter className="flex justify-between">
              ...
              <Button
                ...
                disabled={
                  selectedTasks.every((selected) => !selected) ||
