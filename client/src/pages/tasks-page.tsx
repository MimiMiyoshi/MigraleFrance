...
const TasksPage = () => {
  ...
  const [tasks, setTasks] = useState<VisaTask[]>([
    ...
    },
    {
      ...
      title: "ビザ申請書の記入",
      description:
        "公式ウェブサイトから長期学生ビザ申請書をダウンロードして記入してください",
      completed: true,
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow py-12 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* 進捗状況ヘッダー */}
          <Card
            className="mb-6 bg-gradient-to-r from-blue-50 to-indigo-50 border-none shadow-sm"
            id="task-filters"
          >
              ...
              <Card>
                <CardContent className="py-6">
                  <p className="text-center text-gray-500">
                    未完了のタスクはありません。新しいタスクを追加して始めましょう。
                  </p>
                </CardContent>
              </Card>
            ) : (
            ...
            <div>
              ...
              <div className="space-y-4">
                {completedTasks.map((task) => (
                  <Card
                    key={task.id}
                    className="border-l-4 border-l-green-500 bg-gray-50"
                  >
                    <CardHeader className="py-4">
                      <div className="flex items-start justify-between">
                        <div className="flex items-start space-x-3">
                          ...
                          <div>
                            ...
                            {task.description && (
                              <CardDescription className="mt-1 line-through text-gray-400">
                                {task.description}
                              </CardDescription>
                            )}
                          </div>
